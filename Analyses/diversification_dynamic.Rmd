...
```{r extract_ages, dependson=knitr::all_labels()}
# 
...
```{r bd, dependson=knitr::all_labels()}
...
```{r ess, dependson=knitr::all_labels()}
...
```{r age_shifts, dependson=knitr::all_labels()}
...
```{r plot_shifts, dependson=knitr::all_labels()}
